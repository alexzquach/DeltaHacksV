...
public class TreatmentAdapter extends ArrayAdapter<Treatment_Tbl> {
    private Context context;
    ArrayList<Treatment_Tbl> glb_stdList;
    private int l_layout;
    public TreatmentAdapter(Context i_context, int i_layout, ArrayList<Treatment_Tbl> i_ALObject) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Treatment_Tbl stdl = getItem(position);
        holder.idpk.setText(String.valueOf(stdl.TreatmentID));
        holder.title.setText(stdl.TreatmentName);
        holder.subtitle.setText(String.valueOf(stdl.WhereToFind));
        //get image
