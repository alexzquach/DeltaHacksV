...
public class SkinConditionAdapter extends ArrayAdapter<SkinCondition_Tbl> {
    private Context context;
    ArrayList<SkinCondition_Tbl> glb_stdList;
    private int l_layout;
    public SkinConditionAdapter(Context i_context, int i_layout, ArrayList<SkinCondition_Tbl> i_ALObject) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.imgBt.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    final Treatment_Tbl l_row = (Treatment_Tbl) cb.getTag();
                    int l_status = 0;
                    final int l_id = l_row.TreatmentID;
                    String a = l_row.TreatmentName;
        ...
        SkinCondition_Tbl stdl = getItem(position);
        holder.idpk.setText(String.valueOf(stdl.SkinConditionID));
        holder.title.setText(stdl.SkinConditionName);
        if (stdl.Dangerous == 1){
            holder.subtitle.setTextColor(Color.RED);
            holder.subtitle.setText("Dangerous");
        }else{
            holder.subtitle.setTextColor(Color.GRAY);
            holder.subtitle.setText("Not Dangerous");
        }
        //get image
    ...
    public void DeleteDiaglog(final int i_id, final Treatment_Tbl i_row){
