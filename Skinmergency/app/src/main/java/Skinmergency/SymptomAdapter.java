...
public class SymptomAdapter extends ArrayAdapter<Symptom_Tbl> {
    private Context context;
    ArrayList<Symptom_Tbl> glb_stdList;
    private int l_layout;
    public SymptomAdapter(Context i_context, int i_layout, ArrayList<Symptom_Tbl> i_ALObject) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.imgBt.setOnClickListener(new View.OnClickListener() {
                public void onClick(View v) {
                    ...
                    final Symptom_Tbl l_row = (Symptom_Tbl) cb.getTag();
                    int l_status = 0;
                    final int l_id = l_row.SymptomID;
                    String a = l_row.SymptomName;
        ...
        Symptom_Tbl stdl = getItem(position);
        holder.idpk.setText(String.valueOf(stdl.SymptomID));
        holder.title.setText(stdl.SymptomName);
        //get image
    ...
    public void DeleteDiaglog(final int i_id, final Symptom_Tbl i_row){
